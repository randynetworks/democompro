...
class profilController extends Controller
{
    ...
    public function getDataJson()
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->editColumn('gambar',function ($data) {
                // menampilkan gambar di datatable
                $alt = $data['gambar'];
            ...
            ->rawColumns(['opsi', 'gambar', 'deskripsi']) // render html di dalam datatable
            ->make();
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasFile('gambar')) { // cek apakah ada request file
            ...
            $imageName = time().'.'.$image->getClientOriginalExtension(); // mmebuat nama file -> stemple waktu unix saat ini + ekstensi file asli
        ...
        $profil->url_youtube = $this->getYoutubeEmbedUrl($request->url_youtube); // menamnggil fungsi untuk mengubah url youtube menjadi url embed
        $profil->save();  
    ...
    {
        // fungsi untuk mengubah url youtube menjadi url embed
