                    ...
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pb-0 pt-10">
                                <form id="form-add-sertifikat" class="form"
                                    action="{{ route('sertifikat-prestasi.store') }}" autocomplete="off" method="POST"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control mb-4 mr-4" name="nama_en"
                                                    id="nama_en" placeholder="Masukan Nama (Bahasa Inggris)">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
...
@section('js')
    <script>
        ...
        function validasi() {
            const form = document.getElementById('form-add-sertifikat');
                    ...
                    fields: {
                        ...
                        'kategori': {
                            validators: {
                                callback:{
                                    callback:(input) => {
                                        const elemenSelect = document.querySelector(' #form-add-sertifikat > div.row.fv-plugins-icon-container > div.col-6 > div:nth-child(3) > span > span.selection > span');
