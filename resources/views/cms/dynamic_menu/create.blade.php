                    ...
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pb-0 pt-10">
                                <form id="form-add-menu" class="form" action="{{ route('menu-dinamis.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control mb-4 mr-4" name="navbar"
                                                    id="navbar" placeholder="Masukan Judul untuk Navbar">
                                            </div>
                                            <div class="col-md-12">                                                
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                        ...
                                        <div class="col-6">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control mb-4 mr-4" name="navbar_en"
                                                    id="navbar_en" placeholder="Masukan Judul untuk Navbar (Bahasa Inggris)">
                                            </div>
                                            <div class="col-md-12">                                                
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                        ...
                                        <div class="col-12">
                                            <div class="col-md-12 mt-4">
                                                ...
                                                <textarea name="body" id="body" placeholder="Masukan Code HTML untuk body" class="mb-2 form-control" style="height: 150px;"></textarea>
                                            </div>
                                        </div>
                                    </div>
...
@section('js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function translate() {
                var navbarValue = document.getElementById('navbar').value; // Correct variable name
                var deskripsiValue = document.getElementById('deskripsi').value; // Correct variable name
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                _token: '{{ csrf_token() }}',
                                text: navbarValue // Use the correct variable here
                            },
                        ...
                        $.ajax({
                            ...
                            data: {
                                _token: '{{ csrf_token() }}',
                                text: deskripsiValue // Use the correct variable here
                            },
                            success: function(response) {
