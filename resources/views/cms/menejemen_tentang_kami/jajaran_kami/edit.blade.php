				...
				<div class="col-xl-12 mb-5 mb-xl-10">
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pb-0 pt-10">
                            <form id="form-update-direksi" class="form" action="{{ route('struktur_organisasi.update', $data->id) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4 mr-4" name="nama" id="nama" placeholder="Masukan Nama"  value="{{$data->nama ?? ''}}">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span >Tagline</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="tagline" id="tagline" placeholder="Masukan tagline"  value="{{$data->tagline ?? ''}}">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span >Tagline (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="tagline_en" id="tagline_en" placeholder="Masukan tagline bahasa inggris"  value="{{$data->tagline_en ?? ''}}">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jabatan" name="id_jabatan_fk" id="id_jabatan_fk">
                                                ...
                                                @foreach ($data_jabatan as $i)
                                                    <Option value="{{ $i->id }}" @if ($data->id_jabatan_fk == $i->id) selected="" @endif>{{ $i->jabatan}}</Option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <input type="file" class="form-control mb-4 mr-4" name="gambar" id="gambar" onchange="previewImage(event)" value="{{$data->gambar}}" >
                                        </div>
                                        <img src="{{ asset('images/jajaran-kami/' . $data->gambar) }}" alt="" style="max-height: 300px; width: 100%;" id="image-preview-img" onerror="this.style.display='none'">
                                    </div>
                                    <div class="col-8">
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <textarea name="deskripsi" id="deskripsi" cols="20" rows="10" class="form-control" placeholder="Masukan Deskripsi">{{$data->deskripsi}}</textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class=" mt-3">Deskripsi (Bahasa Inggris)</span>
                                            </label>
                                            <textarea name="deskripsi_en" id="deskripsi_en" cols="20" rows="10" class="form-control" placeholder="Masukan Deskripsi (Bahasa Inggris)">{{$data->deskripsi_en}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end m-4">
                                    <a href="{{ route('struktur_organisasi') }}" class="btn btn-danger me-3">Kembali</a>
                                    <button id="submit_update_direksi" type="submit" class="btn btn-primary">
...
<script>
    ...
    function validasi() {
        const form = document.getElementById('form-update-direksi');

        // Check if the image file exists
        // const imageUrl = '/images/jajaran-kami/' + form.elements['gambar'].value; // Adjust the path as per your application
                ...
                fields: {
                    ...
                    'id_jabatan_fk': {
                            validators: {
                                callback:{
                                    callback:(input) => {
                                        const elemenSelect = document.querySelector('#form-update-direksi > div.row.fv-plugins-icon-container > div.col-8 > div:nth-child(2) > span > span.selection > span');
        ...
        const submitButton = document.getElementById('submit_update_direksi');
