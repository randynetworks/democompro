				...
				<div class="col-xl-12 mb-5 mb-xl-10">
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pb-0 pt-10">
                            <form id="form-add-jabatan" class="form" action="{{ route('master-jabatan.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4 mr-4" name="jabatan" id="jabatan" placeholder="Masukan Jabatan">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Jabatan (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="jabatan_en" id="jabatan_en" placeholder="Masukan Jabatan (Bahasa Inggris)">
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <!-- <input type="number" class="form-control mb-4 mr-4" name="level" id="level" placeholder="Masukan Level" min="1" max="99" onKeyPress="if(this.value.length==13) return false;" onkeydown="return event.keyCode !== 69"> -->
                                            <input type="number" class="form-control mb-4 mr-4" name="level" id="level" placeholder="Masukan Level" min="1" max="99" oninput="validity.valid||(value='');" onkeydown="if(event.key==='e'||event.key==='E')event.preventDefault();">
                                        </div>
                                    </div>
                                </div>
...
<script>    
    ...
    function validasi() {
        const form = document.getElementById('form-add-jabatan');
                ...
                fields: {
                    'jabatan': {
                        validators: {
                            ...
                            remote: { // cek nama jabatan yang sudah ada di dataabase
                                url: "{{ route('master-jabatan.cekJabatan') }}",
                                data: function () {
                                    return {
                                        email: form.querySelector('[name="jabatan"]').value,
                                    };
                                },
                    ...
                    'jabatan_en': {
                        validators: {
                            ...
                            stringLength: {
                                min: 2, // Panjang minimum
                                max: 255, // Panjang maksimum
                                message: 'Nama harus antara 2 hingga 255 karakter.'
                            },
                            remote: { // cek master jabatan en yang sudah ada didatabase
