				...
				<div class="col-xl-12 mb-5 mb-xl-10">
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pb-0 pt-10">
                            <form id="form-add-job" class="form" action="{{ route('manajemen-daftar-lowongan.store') }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-5">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4 mr-4" name="judul" id="judul" placeholder="Masukan Judul Lowongan">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Judul Lowongan (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="judul_en" id="judul_en" placeholder="Masukan Judul Lowongan (Bahasa Inggris)">
                                        </div>                     
                                    </div>
                                    <div class="col-7">
                                        <div class="col-md-12">                        
                                        ...
                                        <img src="" alt="" style="max-height: 200px; display: none;"  id="image-preview-img" >
                                    </div>
                                    <div class="col-12">
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <textarea id="deskripsi" name="deskripsi" class="mb-2 form-control" style="height: 150px;" placeholder="Masukan Deskripsi"></textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required mt-3">Deskripsi (Bahasa Inggris)</span>
                                            </label>
                                            <textarea id="deskripsi_en" name="deskripsi_en" class="mb-2 form-control" style="height: 150px;" placeholder="Masukan Deskripsi (Bahasa Inggris)"></textarea>
                                        </div>
                                    </div>
                                </div>
...
<script>    
    ...
    function validasi() {
        ...
        submitButton.addEventListener('click', function(e) {
            ...
            // update nilai elemet asli di ckeditor 
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // jika button translate di klik
        document.getElementById('translateBtn').addEventListener('click', translate);

        function translate() {
            // get value dari inputan
            var judul = document.getElementById('judul').value;
            // get value dari inputan dengan ckeditor
