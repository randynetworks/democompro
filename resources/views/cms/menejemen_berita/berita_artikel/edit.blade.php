				...
				<div class="col-xl-12 mb-5 mb-xl-10">
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pb-0 pt-10">
                            <form id="form-edit-berita" class="form" action="{{ route('berita-artikel.update', $data->id) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-4">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4 mr-4" name="judul" id="judul" placeholder="Masukan Judul Berita" value="{{$data->judul}}">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Judul Berita (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="judul_en" id="judul_en" placeholder="Masukan Judul Berita (Bahasa Inggris)" value="{{$data->judul_en}}">
                                        </div>                                                                                           
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <select class="form-select mb-2" data-control="select2"
                                                ...
                                                <option></option>
                                                <option value="1" @if ($data->kategori == 1) selected="" @endif>Berita</option>
                                                <option value="2" @if ($data->kategori == 2) selected="" @endif>Artikel</option>
                                            </select>
                                        </div>                                                              
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <input class="form-control mb-4 mr-4 date" name="waktu" id="waktu"
                                                placeholder="Masukan Waktu" value="{{$data->waktu}}">
                                        </div>
                                        <div class="col-md-12">                        
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                        ...
                                        <img src="{{ asset('/images/berita_artikel/' . $data->thumbnail) }}" alt="" height="300px" width="300px"  id="image-preview-img" onerror="this.style.display='none'">
                                    </div>
                                    <div class="col-8">                                        
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <textarea id="isi_berita" name="isi_berita" class="mb-2 form-control" style="height: 150px;" placeholder="Masukan Isi Berita">{{$data->isi_berita}}</textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required mt-3">Isi Berita (Bahasa Inggris)</span>
                                            </label>
                                            <textarea id="isi_berita_en" name="isi_berita_en" class="mb-2 form-control" style="height: 150px;" placeholder="Masukan Isi Berita (Bahasa Inggris)">{{$data->isi_berita_en}}</textarea>
                                        </div>
                                    </div>
                                </div> 
...
<script>    
    ...
    function validasi() {
        ...
        // const imageUrl = '/images/berita_artikel/' + form.elements['thumbnail'].value; // Adjust the path as per your application
