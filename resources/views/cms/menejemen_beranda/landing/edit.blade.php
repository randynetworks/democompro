                ...
                <div class="col-xl-12 mb-5 mb-xl-10">
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body pb-0 pt-10">
                            <form id="form-edit-landing" class="form" action="{{ route('manajemen-landing-page.update', $data->id) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4" name="nama_perusahaan" id="nama_perusahaan" placeholder="Masukan Nama Perusahaan" value="{{$data->nama_perusahaan}}">
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                        ...
                                        <img src="{{ asset('/images/landing/' . $data->gambar) }}" alt="" style="max-height: 300px; width: 100%;" id="image-preview-img" onerror="this.style.display='none'">
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-sm-12">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4" name="motto" id="motto" placeholder="Masukan Motto Perusahaan" value="{{$data->motto}}">
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class=" mt-3">Motto (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4" name="motto_en" id="motto_en" placeholder="Masukan Motto Perusahaan (Bahasa Inggris)" value="{{$data->motto_en}}">
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class=" mt-3">Deskripsi</span>
                                            </label>
                                            <textarea id="deskripsi" name="deskripsi" class="mb-2 form-control" placeholder="Masukan Deskripsi">{{$data->deskripsi}}</textarea>
                                        </div>
                                        <div class="mb-3 col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class=" mt-3">Deskripsi (Bahasa Inggris)</span>
                                            </label>
                                            <textarea id="deskripsi_en" name="deskripsi_en" class="mb-2 form-control" placeholder="Masukan Deskripsi (Bahasa Inggris)">{{$data->deskripsi_en}}</textarea>
                                        </div>
                                    </div>
                                </div>
...
<script>    
    ...
    function validasi() {
        const form = document.getElementById('form-edit-landing');
        
        // Check if the image file exists
        // const imageUrl = '/images/landing/' + form.elements['gambar'].value; // Adjust the path as per your application
