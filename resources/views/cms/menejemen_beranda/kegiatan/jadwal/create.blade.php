                    ...
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pb-0 pt-10">
                                <form id="form-add-jadwal" class="form" action="{{ route('jadwal.store') }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <textarea id="headline_en" name="headline_en" class="mb-2 form-control"
                                                    placeholder="Masukan Headline Acara (Bahasa Inggris)" cols="30" rows="2"></textarea>
                                            </div>
                                            <div class="col-md-12 mb-4">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <textarea id="deskripsi_en" name="deskripsi_en" class="mb-2 form-control"
                                                    placeholder="Masukan Deskripsi Acara (Bahasa Inggris)" cols="30" rows="3"></textarea>
                                            </div>
                                            <div class="col-md-12 mb-4">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
...
@section('js')
    <script>
        ...
        function validasi() {
            const form = document.getElementById('form-add-jadwal');
