                    ...
                    <div class="col-xl-12 mb-5 mb-xl-10">
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pb-0 pt-10">
                                <form id="form-create-dokumentasi" class="form"
                                    action="{{ route('dokumentasi.update', $data->id) }}" autocomplete="off" method="POST"
                                        ...
                                        <div class="col-4">                                            
                                            <!-- <div class="col-md-12">
                                                ...
                                                <select class="form-select mb-2" data-control="select2"
                                                    ...
                                                    <option></option>
                                                    <option value="1"
                                                        @if ($data->kategori == 1) selected="" @endif>Sosial</option>
                                                    <option value="2"
                                                        @if ($data->kategori == 2) selected="" @endif>Acara</option>
                                                </select>
                                            </div> -->
                                            <div class="col-md-12">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <img src="{{ asset('/images/dokumentasi/' . $data->gambar) }}" alt=""
                                                style="max-height: 300px; width: 100%;" id="image-preview-img">
                                        </div>
                                        <div class="col-8">
                                            <div class="col-md-12">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="text" id="text" cols="20" rows="3" class="form-control" placeholder="Masukan Teks">{{ $data->text }}</textarea>
                                            </div>
                                            <div class="col-md-12">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                ...
                                                <textarea name="text_en" id="text_en" cols="20" rows="3" class="form-control"
                                                    placeholder="Masukan Text (Bahasa Inggris)">{{ $data->text_en }}</textarea>
                                            </div>
                                        </div>
                                    </div>
