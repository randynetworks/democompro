				...
				<div class="col-xl-12 mb-5 mb-xl-10">
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pb-0 pt-10">
                            <form id="form-add-nilai" class="form" action="{{ route('manajemen-nilai.update',$data->id) }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control mb-4 mr-4" name="text" id="text" placeholder="Masukan Teks" value="{{$data->text}}">
                                        </div> 
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span class="required">Text (Bahasa Inggris)</span>
                                            </label>
                                            <input type="text" class="form-control mb-4 mr-4" name="text_en" id="text_en" placeholder="Masukan Text (Bahasa Inggris)" value="{{$data->text_en}}">
                                        </div>                                                                                 
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span>Deskripsi</span>
                                            </label>
                                            <textarea class="form-control mb-4 mr-4" name="deskripsi" id="deskripsi" placeholder="Masukan Deskripsi">{{$data->deskripsi}}</textarea>
                                        </div>                                                                         
                                        <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                <span>Deskripsi (Bahasa Inggris)</span>
                                            </label>
                                            <textarea class="form-control mb-4 mr-4" name="deskripsi_en" id="deskripsi_en" placeholder="Masukan Deskripsi (Bahasa Inggris)">{{$data->deskripsi_en}}</textarea>
                                        </div>                          
                                        <!-- <div class="col-md-12">
                                            <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            ...
                                            <textarea name="icon" id="icon" cols="20" rows="5" class="form-control" placeholder="Masukan SVG">{{$data->icon}}</textarea>
                                        ...
                                        <img src="{{ asset('/images/nilai_by_gambar/' . $data->gambar) }}" alt=""
