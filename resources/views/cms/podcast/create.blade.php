                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-body pb-0 pt-10">
                                <form id="form-add-podcast" class="form"
                                    action="{{ route('video.store') }}" autocomplete="off" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-2">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select mb-5" id="inputType" aria-label="Pilih Kategori" style="width: 150px;">
                                        ...
                                        <div class="col-12 col-md-10">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control mb-5" name="youtube_link" id="youtube_link" placeholder="Masukan Link YouTube">
                                        ...
                                        <div class="col-6">                                            
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control mb-4 mr-4 date" name="judul" id="judul" placeholder="Masukan Judul"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="col-md-12">
                                                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                                    <span class="required">Judul (Bahasa Inggris)</span>
                                                </label>
                                                <textarea class="form-control mb-4 mr-4 date" name="judul_en" id="judul_en" placeholder="Masukan Judul (Bahasa Inggris)"></textarea>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function validasi() {
                ...
                form, {
                    ...
                    onSuccess: function (e) {
                        ...
                        if (!youtubeLink && !videoFile) {
                            ...
                            alert('Harap isi salah satu dari YouTube link atau file video.');
                        }
                    }
                }
            );
            ...
            submitButton.addEventListener('click', function(e) {
                ...
                if (youtubeLinkInput.value.trim() === '' && videoFileInput.files.length === 0) {
                    inputTypeSelect.style.borderColor = 'red';
                    youtubeLinkInput.style.borderColor = 'red';
                    videoFileInput.style.borderColor = 'red';
                    errorMessage.classList.remove('d-none');
                }else if (validator) {
                    inputTypeSelect.style.borderColor = 'green';
                    youtubeLinkInput.style.borderColor = 'green';
                    videoFileInput.style.borderColor = 'green';
