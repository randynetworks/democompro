            ...
            <div class="position-breadcrumb">
                <nav aria-label="breadcrumb" class="d-inline-block">
                    <ul class="breadcrumb rounded shadow mb-0 px-4 py-2">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@lang('layout.media.dokumentasi')</li>
                    </ul>
                </nav>
            </div>
        </div> <!--end container-->
...
@section('scripts')
    <script>
        ...
        function sertifikat(search, page) {
            ...
            $.ajax({
                url: "{{ route('dokumentasi.json') }}?search=" + search + "&page=" + page,
                type: 'GET',
                dataType: 'json',
