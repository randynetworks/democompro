        ...
        <div class="tiny-slide tns-item tns-slide-active" id="tns1-item2">
            <div class="card border-0 work-container work-primary work-grid position-relative d-block overflow-hidden my-2 mx-1">
                <div class="card-body p-0"  style="height: 200px;">
                    <a target="_blank" href="{{ asset('images/sertifikat') . '/' . $srt->gambar }}"
                        class="lightbox d-inline-block tobii-zoom" title="">
                        <img src="{{ asset('images/sertifikat') . '/' . $srt->gambar }}" class="img-fluid shadow rounded"
                            alt="work-image"
                        ...
                        <div class="content p-3">
                            <h5 class="mb-0"><a href="javascript:void(0)"
                                    class="text-dark title">{{ $srt->nama ?? '-' }}</a></h5>
