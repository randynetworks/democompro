...
if(document.getElementsByClassName('tiny-single-item-1').length > 0) {
    var slider = tns({
        container: '.tiny-single-item-1',
        items: 1,
        controls: false,
        mouseDrag: true,
        loop: true,
...
if(document.getElementsByClassName('tiny-four-item').length > 0) {
    ...
    //     },
    // });
    var sliders = document.querySelectorAll('.tiny-four-item');
...
if(document.getElementsByClassName('tiny-seven-item').length > 0) {
    var slider = tns({
        container: '.tiny-seven-item',
        controls: false,
        mouseDrag: true,
        loop: true,
        rewind: true,
