...
class MainController extends Controller
{
    public function index()
    {
        ...
        if($locale == 'id'){
            ...
            $podcast = Podcast::latest('created_at')->first(['id', 'url','embed', 'judul']);
            ...
            $podcast = Podcast::latest('created_at')->first(['id', 'url','embed', 'judul_en as judul']);
