...
class dokumentasiController extends Controller
{
    ...
    public function getDataJson()
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->editColumn('gambar',function ($data) {
                $alt = $data['gambar'];
                // $img = '<img src="images/dokumentasi/' . $alt . '" alt="$alt" height="174px" width="174px">';
            ...
            ->rawColumns(['opsi', 'gambar','kategori','waktu','text'])
            ->make();
    }
    ...
    {            
        ...
        if ($request->hasFile('gambar')) {
            ...
            $destinationPath = public_path('/images/dokumentasi');
