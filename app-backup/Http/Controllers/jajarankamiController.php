...
class jajarankamiController extends Controller
{
    ...
    public function getDataJson()
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->editColumn('gambar',function ($data) {
                $alt = $data['gambar'];
                // $img = '<img src="images/jajaran-kami/' . $alt . '" alt="$alt" height="174px" width="174px">';
            ...
            ->rawColumns(['opsi', 'gambar','jabatan','deskripsi','nama'])
            ->make();
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('gambar')) {
            ...
            $destinationPath = public_path('/images/jajaran-kami');
    ...
    public function uploadImage(Request $request)
    {
         ...
         $request->validate([
            ...
            // You can store the image name in the database if needed
